#Oepn Source Code Given By FREE
# All credit Goes to FREE_xd_Xy
#-----------------[ IMPORT-MODULE ]-------------------
...
try:
	...
	print('[[\x1b[1;92mâ€¢\x1b[1;97m] [\x1b[1;96mWELL COME TO FREE TOOL \033[1;35mâ€¢ \033[1;36mâ€¢ \033[1;34mâ€¢')
...
\033[1;32m
\033[1;37;1m[!]======================================================
\033[1;37;1m[√] Author   : FREE 
\033[1;37;1m[√] Facebook : XXXXXXXX
\033[1;37;1m[√] Whatsapp : XXXXX
\033[1;37;1m[√] GitHub   : FREE
\033[1;37;1m[√] Youtube  : FREE TRICKS 
\033[1;37;1m[√] Virson   : X.X.X
\033[1;37;1m[!]====================================================== ''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t[bold cyan]  \033[1;34mâ€¢ \033[1;35mâ€¢ \033[1;36mâ€¢ PLEASE INPUT : [green]FRESH COOKIES[white]'))
...
def menu(my_name,my_id):
	...
	print(f'[{H}âˆš{P}] [%s02%s] RANDOM CRACKER   [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	...
	print("%sâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•%s"%(B,P))
	_____FREE__xd_____ = input('\n>> Choise : ')
	if _____FREE__xd_____ in ['1']:
		dump_massal()
	elif _____FREE__xd_____ in ['2']:
		dump_follower()
	elif _____FREE__xd_____ in ['3']:
		grup()
	elif _____FREE__xd_____ in ['4']:
		crack_file()
	elif _____FREE__xd_____ in ['5']:
		result()
	elif _____FREE__xd_____ in ['0']:
...
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
	try:vin = os.listdir('/sdcard/FREE-DUMP')
	except FileNotFoundError:
	...
	if len(vin)==0:
		...
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/FREE-DUMP/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
		...
		try:geh = lol[geeh]
			...
			time.sleep(3)
			back()
		try:lin = open('/sdcard/FREE-DUMP/'+geh,'r').read().splitlines()
		except:
...
def setting():
	...
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	pwplus=input('>> ARE YOU WANT TO CHOISE PAASS TYPE(Y) or auto pass chise (t) ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}â€¢{k}â€¢{h}â€¢{x} Proces start w8 for runing{m}â€¢{k}â€¢{h}â€¢{x} <<<<< ')
	print('')
...
if __name__=='__main__':
	...
	FREE_xd(f'\n\t{x}â€”â€”> {h}HY GYEZ I AM FREE\n\t{x}â€”â€”> {h}GYEZ INPUT NEW PUBLICK ACOUNT LINK\n\t{x}â€”â€”> {h}ACOUNT FRIND LIST 3000/OR 4000\n\t{x}â€”â€”> {h}THEN ENJOY ALL OK IDZðŸ\n\t{x}â€”â€”> {h}SO JOIN MY FB GROUP ðŸ…{x}')
	time.sleep(3)
	login()
